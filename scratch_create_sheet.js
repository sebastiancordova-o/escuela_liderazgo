...
async function run() {
  ...
  try {
    console.log('Intentando crear hoja nativa de Google Sheets...');
    const res = await sheets.spreadsheets.create({
      requestBody: {
        properties: {
          title: 'Cumbre Liderazgo Lab 2026',
        },
        sheets: [
          { properties: { title: 'Respuestas de formulario 1' } },
          { properties: { title: '2026' } },
        ]
      }
    });
    console.log('EXITO CREANDO SPREADSHEET!');
